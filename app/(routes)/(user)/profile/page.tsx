        ...
        <div className="min-h-screen">
            ...
            <div className="w-[75%] px-20 pt-24 pb-20">
                <MainContent
                    ...
                    savedArticlesIDs={userProfile?.savedArticlesIDs}
                />
            </div>
            {/* End Main Content */}
            {/* Start Sidebar */}
            <div className="w-[25%] h-full fixed right-0 top-0 bottom-0 shadow-xl shadow-shadows p-5 flex justify-center items-center">
                <Sidebar
                    id={userProfile?.id}
                    name={userProfile?.name}
                    pic={userProfile?.pic}
                    followingTopics={
                        userProfile?.followingTopicsNames.length
